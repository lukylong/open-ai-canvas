...
func migrations() []tableMigration {
	return []tableMigration{
		...
		migrateTable[model.InvitationCode]("invitation_codes"),
		migrateTable[model.InvitationCodeUsage]("invitation_code_usages"),
		...
		migrateTable[model.SharedAssetSeries]("shared_asset_series"),
		migrateTable[model.SharedAssetUploadBatch]("shared_asset_upload_batches"),
		migrateTable[model.SharedAssetUploadItem]("shared_asset_upload_items"),
		migrateTable[model.MigrationRun]("migration_runs"),
		migrateTable[model.MigrationEntityMap]("migration_entity_maps"),
		migrateTable[model.MigrationConflict]("migration_conflicts"),
		migrateTable[model.DistributionPublication]("distribution_publications"),
		migrateTable[model.DistributionOutbox]("distribution_outboxes"),
		migrateTable[model.DirectorPromptProposal]("director_prompt_proposals"),
		...
		migrateTable[model.SharedAsset]("shared_assets"),
		...
		migrateTable[model.ProjectSharedAssetLink]("project_shared_asset_links"),
		...
		migrateTable[model.TaskBatch]("task_batches"),
		migrateTable[model.TaskBatchItem]("task_batch_items"),
